...
namespace QuanLyBanVe.Class
{
    class VietHoaXtraMessageBox : Localizer
    {
        ...
        public VietHoaXtraMessageBox(string abort, string cancel, string ignore, string no, string ok, string retry, string yes)
        {
            this.Abort = abort;
            this.Cancel = cancel;
            this.Ignore = ignore;
